...
namespace General\Mail\Transport;

use General\Mail\Address;
use General\Mail\Headers;
use General\Mail\Message;
use General\Mail\Protocol;
use General\Mail\Protocol\Exception as ProtocolException;
