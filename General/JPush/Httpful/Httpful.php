...
class Httpful {
     ...
     */
    public static function register($mimeType, \General\JPush\Httpful\Handlers\MimeHandlerAdapter $handler)
    {
    ...
    public static function get($mimeType = null)
    {
        ...
        if (empty(self::$default)) {
            self::$default = new \General\JPush\Httpful\Handlers\MimeHandlerAdapter();
        }
